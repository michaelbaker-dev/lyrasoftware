...
export const CLOUD_MODELS: CloudModelInfo[] = [
  ...
  {
    id: "claude-code/opus",
    label: "Claude Opus Latest (CLI)",
    source: "cloud",
    inputPerMillion: null,
    outputPerMillion: null,
    tier: "premium",
    description: "Best reasoning, latest version. Uses Max subscription.",
  },
  {
    id: "claude-code/sonnet",
    label: "Claude Sonnet Latest (CLI)",
    source: "cloud",
    inputPerMillion: null,
    outputPerMillion: null,
    tier: "standard",
    description: "Balanced quality, latest version. Uses Max subscription.",
  },
  {
    id: "claude-code/haiku",
    label: "Claude Haiku Latest (CLI)",
    source: "cloud",
    inputPerMillion: null,
    outputPerMillion: null,
    tier: "budget",
    description: "Fast, good for simple tasks, latest version. Uses Max subscription.",
  },
  {
